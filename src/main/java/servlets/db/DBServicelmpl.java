 ...
 */
public class DBServicelmpl  implements DBService {
    private static final String hibernate_show_sql = "true";
    private static final String hibernate_hbm2ddl_auto = "update";

    private final SessionFactory sessionFactory;

    public DBServicelmpl() {
    ...
    private Configuration getPSQLConfiguration() {
        ...
        configuration.setProperty("hibernate.connection.url", "jdbc:postgresql://127.0.0.1:5432/javatest");
        configuration.setProperty("hibernate.connection.username", "kirill");
        configuration.setProperty("hibernate.connection.password", "4865");
        configuration.setProperty("hibernate.show_sql", hibernate_show_sql);
        configuration.setProperty("hibernate.hbm2ddl.auto", hibernate_hbm2ddl_auto);
        return configuration;
    }
